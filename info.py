...
API_ID = int(environ.get('API_ID', '25216035'))
API_HASH = environ.get('API_HASH', '49f43d961586a02803de09571b345eb2'')
BOT_TOKEN = environ.get('BOT_TOKEN', "8395150974:AAEO6kfHJVSKA491UVbwhR82Z2YyZMs2ogM")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002612458623').split()] #Channel id for auto indexing ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rsenterprises201925:Shiva@2025@cluster0.gfol7cr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '3766680593d7db60d31f9985aa10d614785b7858')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '1002176263843')) #Log channel id ( make sure bot is admin )
